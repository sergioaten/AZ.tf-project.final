...
$VaultName = "TF-Project-rsv" #fetch automatically
$Subscription = "Azure for Students" #fetch automatically
$ResourceGroup = "TF-Project" #fetch automatically
$SubscriptionId = "4cefcea5-7331-477c-a5d5-da6957ee15c7" #fetch automatically
